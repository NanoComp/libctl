...
void mesh_copy(const mesh *o0,mesh *o)
{
{
int i_t;
...
boolean mesh_equal(const mesh *o0, const mesh *o)
{
{
int i_t;
...
{
int i_t;
if (o->face_indices.num_items != o0->face_indices.num_items) return 0;
for (i_t = 0; i_t < o->face_indices.num_items; i_t++) {
if (!vector3_equal(o->face_indices.items[i_t], o0->face_indices.items[i_t])) return 0;
}
}
if (o->is_closed != o0->is_closed) return 0;
if (o->internal != o0->internal) return 0;
;
return 1;
}
...
{
int i_t;
if (o->vertices_p.num_items != o0->vertices_p.num_items) return 0;
for (i_t = 0; i_t < o->vertices_p.num_items; i_t++) {
if (!vector3_equal(o->vertices_p.items[i_t], o0->vertices_p.items[i_t])) return 0;
}
}
{
int i_t;
if (o->top_polygon_diff_vectors_p.num_items != o0->top_polygon_diff_vectors_p.num_items) return 0;
for (i_t = 0; i_t < o->top_polygon_diff_vectors_p.num_items; i_t++) {
if (!vector3_equal(o->top_polygon_diff_vectors_p.items[i_t], o0->top_polygon_diff_vectors_p.items[i_t])) return 0;
}
}
{
int i_t;
if (o->top_polygon_diff_vectors_scaled_p.num_items != o0->top_polygon_diff_vectors_scaled_p.num_items) return 0;
for (i_t = 0; i_t < o->top_polygon_diff_vectors_scaled_p.num_items; i_t++) {
if (!vector3_equal(o->top_polygon_diff_vectors_scaled_p.items[i_t], o0->top_polygon_diff_vectors_scaled_p.items[i_t])) return 0;
}
}
{
int i_t;
if (o->vertices_top_p.num_items != o0->vertices_top_p.num_items) return 0;
for (i_t = 0; i_t < o->vertices_top_p.num_items; i_t++) {
if (!vector3_equal(o->vertices_top_p.items[i_t], o0->vertices_top_p.items[i_t])) return 0;
}
}
{
int i_t;
if (o->vertices_top.num_items != o0->vertices_top.num_items) return 0;
for (i_t = 0; i_t < o->vertices_top.num_items; i_t++) {
if (!vector3_equal(o->vertices_top.items[i_t], o0->vertices_top.items[i_t])) return 0;
}
}
...
{
if (o->material != o0->material) return 0;
if (!vector3_equal(o->center, o0->center)) return 0;
if (o0->which_subclass != o->which_subclass) return 0;
if (o0->which_subclass == MESH) {
if (!mesh_equal(o0->subclass.mesh_data, o->subclass.mesh_data)) return 0;
}
else if (o0->which_subclass == PRISM) {
...
{
int index_t;
for (index_t = 0; index_t < o.face_indices.num_items; index_t++) {
}
}
free(o.face_indices.items);
mesh_after_destroy(&o);
}
